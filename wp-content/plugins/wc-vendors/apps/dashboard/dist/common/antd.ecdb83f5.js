import { h as Q, n as Ot, c as T } from './vendor.0319ebde.js'
function l(t, e) {
  Ct(t) && (t = '100%')
  var r = Mt(t)
  return (
...
function Ht(t, e, r) {
  ...
  if (((t = l(t, 360)), (e = l(e, 100)), (r = l(r, 100)), e === 0))
    ...
    var o = r < 0.5 ? r * (1 + e) : r + e - r * e,
      c = 2 * r - o
    ;(n = j(c, o, t + 1 / 3)), (a = j(c, o, t)), (i = j(c, o, t - 1 / 3))
  }
...
var er = (function() {
    ...
    return (
      ...
      (t.prototype.setAlpha = function(e) {
        return (
          (this.a = ft(e)), (this.roundA = Math.round(100 * this.a) / 100), this
        )
      }),
      ...
      (t.prototype.toHex = function(e) {
        return e === void 0 && (e = !1), V(this.r, this.g, this.b, e)
      }),
      (t.prototype.toHexString = function(e) {
        return e === void 0 && (e = !1), '#' + this.toHex(e)
      }),
      (t.prototype.toHex8 = function(e) {
        return e === void 0 && (e = !1), At(this.r, this.g, this.b, this.a, e)
      }),
      ...
      (t.prototype.toName = function() {
        ...
        for (
          var e = '#' + V(this.r, this.g, this.b, !1),
            r = 0,
            n = Object.entries(_);
          r < n.length;
          r++
      ...
      (t.prototype.lighten = function(e) {
        e === void 0 && (e = 10)
        var r = this.toHsl()
        return (r.l += e / 100), (r.l = M(r.l)), new t(r)
      }),
      ...
      (t.prototype.desaturate = function(e) {
        e === void 0 && (e = 10)
        var r = this.toHsl()
        return (r.s -= e / 100), (r.s = M(r.s)), new t(r)
      }),
...
function tt(t, e, r) {
  ...
  var n
  return (
    r ? (n = t.s - Z * e) : e === dt ? (n = t.s + Z) : (n = t.s + Pt * e),
    n > 1 && (n = 1),
    r && e === ht && n > 0.1 && (n = 0.1),
    n < 0.06 && (n = 0.06),
    Number(n.toFixed(2))
...
function D(t) {
  for (
    ...
    var i = X(n),
      o = k(m({ h: K(i, a, !0), s: tt(i, a, !0), v: et(i, a, !0) }))
    r.push(o)
  }
  r.push(k(n))
  for (var c = 1; c <= dt; c += 1) {
    var s = X(n),
      u = k(m({ h: K(s, c), s: tt(s, c), v: et(s, c) }))
    r.push(u)
  }
  return e.theme === 'dark'
    ? It.map(function(p) {
        var b = p.index,
          C = p.opacity,
          L = k(Vt(m(e.backgroundColor || '#141414'), m(r[b]), C * 100))
        return L
      })
    : r
}
...
Object.keys(E).forEach(function(t) {
  ;(x[t] = D(E[t])),
    (x[t].primary = x[t][5]),
    (R[t] = D(E[t], { theme: 'dark', backgroundColor: '#141414' })),
    (R[t].primary = R[t][5])
})
var rr = x.gold,
  nr = x.blue,
...
`,
  ...
  Be = ['icon', 'primaryColor', 'secondaryColor']
function je(t, e) {
  if (t == null) return {}
  var r = Fe(t, e),
    n,
...
var O = { primaryColor: '#333', secondaryColor: '#E6E6E6', calculated: !1 }
function Ee(t) {
  var e = t.primaryColor,
    r = t.secondaryColor
  ;(O.primaryColor = e), (O.secondaryColor = r || gt(e)), (O.calculated = !!r)
}
function Re() {
  return A({}, O)
}
var y = function(e, r) {
  var n = A({}, e, r.attrs),
    ...
    s = O
  if (
    (i && (s = { primaryColor: i, secondaryColor: o || gt(i) }),
    Le(),
    at(a),
    !at(a))
  )
  ...
  return (
    u &&
      ...
      (u = A({}, u, { icon: u.icon(s.primaryColor, s.secondaryColor) })),
    $(
      u.icon,
      'svg-'.concat(u.name),
      A({}, c, {
...
y.getTwoToneColors = Re
y.setTwoToneColors = Ee
const N = y
function Ie(t, e) {
  return $e(t) || De(t, e) || _e(t, e) || Ve()
}
function Ve() {
...
function pt(t) {
  var e = vt(t),
    ...
    n = r[0],
    a = r[1]
  return N.setTwoToneColors({ primaryColor: n, secondaryColor: a })
}
function qe() {
  var t = N.getTwoToneColors()
...
var S = function(e, r) {
  var n,
    ...
    L =
      ...
      q(n, i, i),
      n),
    mt = c === '' || c || o.name === 'loading' ? 'anticon-spin' : '',
    B = u
  B === void 0 && b && ((B = -1), (C.tabindex = B))
  var yt = s
      ? {
  ...
  return T(
    'span',
    st({ role: 'img', 'aria-label': o.name }, C, { onClick: b, class: L }),
    [
      T(
        N,
        { class: mt, icon: o, primaryColor: wt, secondaryColor: xt, style: yt },
        null
      )
    ]
  )
...
S.inheritAttrs = !1
S.getTwoToneColor = qe
S.setTwoToneColor = pt
const bt = S
function lt(t) {
  for (var e = 1; e < arguments.length; e++) {
    var r = arguments[e] != null ? Object(arguments[e]) : {},
...
var W = function(e, r) {
  var n = lt({}, e, r.attrs)
  return T(bt, lt({}, n, { icon: Oe }), null)
}
W.displayName = 'DownloadOutlined'
W.inheritAttrs = !1
const _r = W
function ut(t) {
  for (var e = 1; e < arguments.length; e++) {
...
var U = function(e, r) {
  var n = ut({}, e, r.attrs)
  return T(bt, ut({}, n, { icon: Me }), null)
}
U.displayName = 'RocketOutlined'
U.inheritAttrs = !1
const Dr = U
export {
  rr as A,
