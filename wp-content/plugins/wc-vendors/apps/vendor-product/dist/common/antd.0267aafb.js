import { h as ct, n as Qt, c as u } from './vendor.015340d9.js'
function s(t, e) {
  Gt(t) && (t = '100%')
  var r = Yt(t)
  return (
...
function Xt(t, e, r) {
  ...
  if (((t = s(t, 360)), (e = s(e, 100)), (r = s(r, 100)), e === 0))
    ...
    var o = r < 0.5 ? r * (1 + e) : r + e - r * e,
      c = 2 * r - o
    ;(n = L(c, o, t + 1 / 3)), (a = L(c, o, t)), (i = L(c, o, t - 1 / 3))
  }
...
function Zt(t, e, r) {
  ...
  var n = Math.floor(t),
    ...
    m = [c, r, r, o, i, i][l],
    y = [i, i, c, r, r, o][l]
  return { r: f * 255, g: m * 255, b: y * 255 }
}
function I(t, e, r, n) {
  var a = [
...
var Zr = (function() {
    function t(e, r) {
      ...
      typeof e == 'number' && (e = ee(e)), (this.originalInput = e)
      var a = O(e)
    ...
    return (
      ...
      (t.prototype.setAlpha = function(e) {
        return (
          (this.a = _t(e)), (this.roundA = Math.round(100 * this.a) / 100), this
        )
      }),
      ...
      (t.prototype.toHex8 = function(e) {
        return e === void 0 && (e = !1), Kt(this.r, this.g, this.b, this.a, e)
      }),
...
function dt(t, e, r) {
  ...
  return (
    Math.round(t.h) >= 60 && Math.round(t.h) <= 240
      ? (n = r ? Math.round(t.h) - H * e : Math.round(t.h) + H * e)
      : (n = r ? Math.round(t.h) + H * e : Math.round(t.h) - H * e),
...
function ht(t, e, r) {
  ...
  var n
  return (
    r ? (n = t.s - ut * e) : e === kt ? (n = t.s + ut) : (n = t.s + ie * e),
    n > 1 && (n = 1),
    r && e === Ft && n > 0.1 && (n = 0.1),
    n < 0.06 && (n = 0.06),
    Number(n.toFixed(2))
...
function R(t) {
  for (
    ...
    var i = ft(n),
      o = A(O({ h: dt(i, a, !0), s: ht(i, a, !0), v: gt(i, a, !0) }))
    r.push(o)
  }
  r.push(A(n))
  for (var c = 1; c <= kt; c += 1) {
    var l = ft(n),
      f = A(O({ h: dt(l, c), s: ht(l, c), v: gt(l, c) }))
    r.push(f)
  }
  return e.theme === 'dark'
    ? le.map(function(m) {
        var y = m.index,
          P = m.opacity,
          E = A(se(O(e.backgroundColor || '#141414'), O(r[y]), P * 100))
        return E
      })
    : r
}
...
Object.keys(F).forEach(function(t) {
  ;(x[t] = R(F[t])),
    (x[t].primary = x[t][5]),
    (k[t] = R(F[t], { theme: 'dark', backgroundColor: '#141414' })),
    (k[t].primary = k[t][5])
})
var Kr = x.gold,
  tn = x.blue,
  ...
  icon: {
    ...
    children: [
      ...
      },
      {
        ...
        attrs: {
          d:
            'M378.4 475.1a35.91 35.91 0 00-50.9 0 35.91 35.91 0 000 50.9l129.4 129.4 2.1 2.1a33.98 33.98 0 0048.1 0L730.6 434a33.98 33.98 0 000-48.1l-2.8-2.8a33.98 33.98 0 00-48.1 0L483 579.7 378.4 475.1z'
        }
      }
    ]
  },
    ...
    children: [
      {
        ...
        attrs: {
          d:
            'M464 720a48 48 0 1096 0 48 48 0 10-96 0zm16-304v184c0 4.4 3.6 8 8 8h48c4.4 0 8-3.6 8-8V416c0-4.4-3.6-8-8-8h-48c-4.4 0-8 3.6-8 8zm475.7 440l-416-720c-6.2-10.7-16.9-16-27.7-16s-21.6 5.3-27.7 16l-416 720C56 877.4 71.4 904 96 904h832c24.6 0 40-26.6 27.7-48zm-783.5-27.9L512 239.9l339.8 588.2H172.2z'
        }
      }
    ]
  },
...
`,
  mt = !1,
  pr = function() {
    var e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : vr
    Qt(function() {
      mt ||
        (typeof window < 'u' &&
          window.document &&
  ...
  br = ['icon', 'primaryColor', 'secondaryColor']
function mr(t, e) {
  if (t == null) return {}
  var r = yr(t, e),
    n,
...
function Sr(t) {
  var e = t.primaryColor,
    r = t.secondaryColor
  ;(M.primaryColor = e), (M.secondaryColor = r || Vt(e)), (M.calculated = !!r)
}
function wr() {
  return $({}, M)
}
var S = function(e, r) {
  var n = $({}, e, r.attrs),
    ...
    l = M
  if (
    (i && (l = { primaryColor: i, secondaryColor: o || Vt(i) }),
    pr(),
    bt(a),
    !bt(a))
  )
  ...
  return (
    f &&
      ...
      (f = $({}, f, { icon: f.icon(l.primaryColor, l.secondaryColor) })),
    N(
      f.icon,
      'svg-'.concat(f.name),
      $({}, c, {
...
S.getTwoToneColors = wr
S.setTwoToneColors = Sr
const W = S
function Cr(t, e) {
  return zr(t) || Pr(t, e) || Mr(t, e) || xr()
}
function xr() {
...
var w = function(e, r) {
  var n,
    ...
    E =
      ((n = { anticon: !0 }),
      q(n, 'anticon-'.concat(o.name), !!o.name),
      q(n, i, i),
      n),
    Rt = c === '' || c || o.name === 'loading' ? 'anticon-spin' : '',
    T = f
  T === void 0 && y && ((T = -1), (P.tabindex = T))
  var Nt = l
      ? {
  ...
  return u(
    'span',
    St({ role: 'img', 'aria-label': o.name }, P, { onClick: y, class: E }),
    [
      u(
        W,
        { class: Rt, icon: o, primaryColor: Wt, secondaryColor: Ut, style: Nt },
        null
      )
    ]
  )
...
w.inheritAttrs = !1
w.getTwoToneColor = jr
w.setTwoToneColor = Dt
const d = w
function wt(t) {
  for (var e = 1; e < arguments.length; e++) {
    var r = arguments[e] != null ? Object(arguments[e]) : {},
...
var U = function(e, r) {
  var n = wt({}, e, r.attrs)
  return u(d, wt({}, n, { icon: tr }), null)
}
U.displayName = 'BulbOutlined'
U.inheritAttrs = !1
const Hn = U
function Ct(t) {
  for (var e = 1; e < arguments.length; e++) {
...
var Q = function(e, r) {
  var n = Ct({}, e, r.attrs)
  return u(d, Ct({}, n, { icon: me }), null)
}
Q.displayName = 'CheckCircleOutlined'
Q.inheritAttrs = !1
const An = Q
function xt(t) {
  for (var e = 1; e < arguments.length; e++) {
...
var G = function(e, r) {
  var n = xt({}, e, r.attrs)
  return u(d, xt({}, n, { icon: rr }), null)
}
G.displayName = 'DollarOutlined'
G.inheritAttrs = !1
const $n = G
function Mt(t) {
  for (var e = 1; e < arguments.length; e++) {
...
var Y = function(e, r) {
  var n = Mt({}, e, r.attrs)
  return u(d, Mt({}, n, { icon: Ze }), null)
}
Y.displayName = 'EditOutlined'
Y.inheritAttrs = !1
const En = Y
function Pt(t) {
  for (var e = 1; e < arguments.length; e++) {
...
var Z = function(e, r) {
  var n = jt({}, e, r.attrs)
  return u(d, jt({}, n, { icon: Le }), null)
}
Z.displayName = 'FileTextOutlined'
Z.inheritAttrs = !1
const Bn = Z
function Ht(t) {
  for (var e = 1; e < arguments.length; e++) {
...
var K = function(e, r) {
  var n = Ht({}, e, r.attrs)
  return u(d, Ht({}, n, { icon: we }), null)
}
K.displayName = 'InfoCircleOutlined'
K.inheritAttrs = !1
const _n = K
function At(t) {
  for (var e = 1; e < arguments.length; e++) {
...
var tt = function(e, r) {
  var n = At({}, e, r.attrs)
  return u(d, At({}, n, { icon: ar }), null)
}
tt.displayName = 'PictureOutlined'
tt.inheritAttrs = !1
const Fn = tt
function $t(t) {
  for (var e = 1; e < arguments.length; e++) {
...
var et = function(e, r) {
  var n = $t({}, e, r.attrs)
  return u(d, $t({}, n, { icon: Ee }), null)
}
et.displayName = 'QuestionCircleOutlined'
et.inheritAttrs = !1
const kn = et
function Et(t) {
  for (var e = 1; e < arguments.length; e++) {
...
var rt = function(e, r) {
  var n = Et({}, e, r.attrs)
  return u(d, Et({}, n, { icon: or }), null)
}
rt.displayName = 'SafetyOutlined'
rt.inheritAttrs = !1
const Vn = rt
function Tt(t) {
  for (var e = 1; e < arguments.length; e++) {
...
var nt = function(e, r) {
  var n = Tt({}, e, r.attrs)
  return u(d, Tt({}, n, { icon: pe }), null)
}
nt.displayName = 'SearchOutlined'
nt.inheritAttrs = !1
const In = nt
function Lt(t) {
  for (var e = 1; e < arguments.length; e++) {
...
var at = function(e, r) {
  var n = Lt({}, e, r.attrs)
  return u(d, Lt({}, n, { icon: lr }), null)
}
at.displayName = 'StopOutlined'
at.inheritAttrs = !1
const Dn = at
function Bt(t) {
  for (var e = 1; e < arguments.length; e++) {
...
var it = function(e, r) {
  var n = Bt({}, e, r.attrs)
  return u(d, Bt({}, n, { icon: ur }), null)
}
it.displayName = 'WarningOutlined'
it.inheritAttrs = !1
const Rn = it
export {
  Bn as A,
