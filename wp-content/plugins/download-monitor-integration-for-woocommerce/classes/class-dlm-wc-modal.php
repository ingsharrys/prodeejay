...
class DLMWC_Modal {
	...
	public function add_footer_scripts() {
		...
		wp_add_inline_script( 'dlm-xhr', 'document.addEventListener("dlm-xhr-modal-data", function (event) {if ("undefined" !== typeof event.detail.headers["x-dlm-woo-locked"]) {event.detail.data["action"]= "dlm_woo_lock_modal";event.detail.data["dlm_modal_response"] = "true";}});', 'after' );
	}
