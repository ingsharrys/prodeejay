...
<body>
    ...
    <div class="container mt-4">
        ...
        <div class="row" id="lamusic">
            <div class="col-sm-1 col-2 flexbox" style="border:1px solid #000;background: #fff;color: #000;"><p class="text-repro">Fecha</p></div>
    ...
    <?php 
        ...
        foreach ($products as $product) {
            ...
            <div class="row product-row">
                <div class="col-sm-1 col-2 flexbox text-repro column-border" style="background: #212121;margin-top: 1%;">
                    <?php $date = new DateTime($product->get_date_created()); echo $monthYear = $date->format('d-m-Y'); ?>
                </div>
